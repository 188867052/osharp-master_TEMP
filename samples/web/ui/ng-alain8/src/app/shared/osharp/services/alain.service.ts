...
export class AlainService {
    ...
    DataTypeTags: STColumnTag = {
        1: { text: 'uniqueidentifier', color: 'red' },
        2: { text: 'nvarchar', color: 'orange' },
        3: { text: 'int', color: 'blue' },
        4: { text: 'bit', color: 'green' },
        5: { text: 'datetime2', color: 'green' },
        6: { text: 'nvarchar', color: 'green' },
        7: { text: 'smallint', color: 'green' },
    };

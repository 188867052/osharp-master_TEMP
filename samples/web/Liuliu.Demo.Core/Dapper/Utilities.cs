...
namespace EFCore.Scaffolding.Extension.Entity.Dapper
{
    ...
    {
        private static readonly ScaffoldConfig dbContext;
        ...
        static Utilities()
        {
            ...
            dbContext = ScaffoldConfig;
        }

        internal static string PK<T>() => dbContext.GetEntity<T>().PrimaryKey;

        internal static string TableOrView<T>() => dbContext.GetEntity<T>().Table + dbContext.GetEntity<T>().View;

        internal static Property[] GetProperties<T>() => dbContext.GetEntity<T>().Properties;
        ...
        internal static void PrepareUpdateOrInsertParameters<T>(T entity, out DynamicParameters parameters)
        {
            ...
            {
                var property = dbContext.GetEntity<T>().Properties.FirstOrDefault(o => o.Name == item.Name);
                if (property != null)
                {
